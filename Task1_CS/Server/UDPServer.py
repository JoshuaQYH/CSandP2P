...
def listFile():
    ...
    file_dir = "C:\\Users\\Qiuyh\\Desktop\\ComNetProject1\\Task1_CS\\Server"    
...
def downloadFile(fileName):
    # 打开要传输的文件
    file = "C:\\Users\\Qiuyh\\Desktop\\ComNetProject1\\Task1_CS\\Server\\" + fileName
    #file = "ComNetProject1\\Task1_CS\\Server\\" + fileName
    print ("send " + file)
    with open(file, 'rb') as fs:
        print("Start to send file")
        while True:
            fileData = fs.read(1024)
            if not fileData:
